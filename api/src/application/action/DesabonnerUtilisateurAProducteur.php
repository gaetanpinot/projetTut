...
class DesabonnerUtilisateurAProducteur extends AbstractAction
{
    ...
    public function __invoke(ServerRequestInterface $rq, ResponseInterface $rs, array $args): ResponseInterface
    {
        ...
        $retour = $this->serviceUtilisateur->deleteProducteurToUtilisateur($utilisateur_id, $producteur_id);
