...
class GetProducteursUtilisateurList extends AbstractAction
{
    ...
    public function __invoke(ServerRequestInterface $rq, ResponseInterface $rs, array $args): ResponseInterface
    {
        ...
        $retour = $this->serviceUtilisateur->getProduceursOfUtilisateur($utilisateur_id);
        return JsonRenderer::render($rs, 200, ['producteurs' => $retour]);
    }
}
